...
import artCafeAPI from '../api/artCafeAPI';
import FoodItemCard from './shared/FoodItemCard';

const ArtCafeMenuPage = ({ setCurrentPage, setSelectedFood, setSelectedRestaurant }) => {
  ...
  useEffect(() => {
    const fetchMenuData = async () => {
      try {
        setLoading(true);
        const data = await artCafeAPI.getFullMenu();
        setMenuData(data);
      } catch (error) {
  ...
  console.log('🔍 Art Cafe Menu Data:', menuData);
    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl text-red-400">Loading Art Cafe's delicious menu...</p>
        </div>
      </div>
    );
  }
  ...
  if (!menuData || !menuData.menu) {
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          <div className="w-16 h-16 border-4 border-red-500 border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
          <p className="text-xl text-red-400">Loading Art Cafe menu...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1">
              <div className="relative">
                <input
                  type="text"
                  placeholder="Search Art Cafe menu..."
                  value={searchTerm}
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-red-400">4.5</div>
...
export default ArtCafeMenuPage;
