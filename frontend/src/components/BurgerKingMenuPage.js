...
import { burgerKingAPI } from '../api/burgerKingAPI';
import FoodItemCard from './shared/FoodItemCard';

const BurgerKingMenuPage = ({ setCurrentPage, setSelectedFood, setSelectedRestaurant }) => {
  ...
  useEffect(() => {
    const fetchMenuData = async () => {
      try {
        setLoading(true);
        const data = await burgerKingAPI.getFullMenu();
        setMenuData(data);
      } catch (error) {
    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl text-orange-400">Preparing Burger King's flame-grilled menu...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1">
              <div className="relative">
                <input
                  type="text"
                  placeholder="Search Burger King menu..."
                  value={searchTerm}
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="text-center">
            ...
            <p className="text-gray-300 mb-4">
              {menuData.restaurant.description || 'Home of the Whopper! Serving flame-grilled burgers, crispy chicken, and delicious fast food favorites since 1954'}
            </p>
            
            {/* Restaurant stats */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              <div className="text-center">
                <div className="text-2xl font-bold text-orange-400">1954</div>
            ...
            {menuData.customization && menuData.customization.available && (
              <div className="mt-6">
                ...
                <div className="space-y-3">
                  {menuData.customization.options.patty && (
                    <div>
                      <h5 className="text-xs font-medium text-orange-600 mb-1">Patty Options:</h5>
                      <div className="flex flex-wrap justify-center gap-1">
                        {menuData.customization.options.patty.map((option, index) => (
                  ...
                  {menuData.customization.options.cheese && (
                    <div>
                      <h5 className="text-xs font-medium text-orange-600 mb-1">Cheese Options:</h5>
                      <div className="flex flex-wrap justify-center gap-1">
                        {menuData.customization.options.cheese.map((option, index) => (
                  ...
                  {menuData.customization.options.toppings && (
                    <div>
                      <h5 className="text-xs font-medium text-orange-600 mb-1">Topping Options:</h5>
                      <div className="flex flex-wrap justify-center gap-1">
                        {menuData.customization.options.toppings.map((option, index) => (
...
export default BurgerKingMenuPage;
