...
const PizzaInnMenuPage = ({ setCurrentPage, setSelectedFood, setSelectedRestaurant }) => {
    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl text-red-400">Preparing Pizza Inn's delicious menu...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1">
              <div className="relative">
                <input
                  type="text"
                  placeholder="Search Pizza Inn menu..."
                  value={searchTerm}
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="text-center">
            ...
            <p className="text-gray-300 mb-4">
              {menuData.restaurant.description || 'Kenya\'s premier pizza chain, serving quality pizzas and Italian cuisine since 1999'}
            </p>
...
export default PizzaInnMenuPage;
