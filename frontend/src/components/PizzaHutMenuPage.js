...
import pizzaInnAPI from '../api/pizzaInnAPI';
import FoodItemCard from './shared/FoodItemCard';

const PizzaHutMenuPage = ({ setCurrentPage, setSelectedFood, setSelectedRestaurant }) => {
  ...
  useEffect(() => {
    const fetchMenuData = async () => {
      try {
        setLoading(true);
        const data = await pizzaInnAPI.getFullMenu();
        setMenuData(data);
      } catch (error) {
    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-xl text-red-400">Preparing Pizza Hut's delicious menu...</p>
        </div>
      </div>
    );
  }
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="text-center">
                <div className="flex items-center justify-center space-x-2 mb-1">
                  ...
                  <h1 className="text-3xl font-bold text-white">Pizza Hut</h1>
                </div>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex-1">
              <div className="relative">
                <input
                  type="text"
                  placeholder="Search Pizza Hut menu..."
                  value={searchTerm}
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          <div className="text-center">
            ...
            <p className="text-gray-300 mb-4">
              {menuData.restaurant.description || 'World\'s most popular pizza chain, serving quality pizzas and Italian cuisine since 1958'}
            </p>
            
            {/* Restaurant stats */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              <div className="text-center">
                <div className="text-2xl font-bold text-red-400">1958</div>
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-red-400">30-45</div>
...
export default PizzaHutMenuPage;
