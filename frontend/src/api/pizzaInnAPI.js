...
class PizzaInnAPI {
  ...
  async getFullMenu() {
    try {
      console.log('🏪 Fetching Pizza Inn full menu...');
      ...
      console.log('✅ Pizza Inn menu data prepared:', menuData);
      ...
      console.error('❌ Error preparing Pizza Inn menu:', error);
  ...
  getMockMenu() {
    return {
      ...
      rewards: { program: 'Inn Rewards', available: true, benefits: ['Earn points on every purchase'] },
...
const pizzaInnAPI = new PizzaInnAPI();
