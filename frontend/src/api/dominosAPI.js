...
class DominosAPI {
  ...
  async getFullMenu() {
    try {
      console.log('🏪 Fetching Domino\'s Pizza full menu...');
      ...
      console.log('✅ Domino\'s Pizza menu data prepared:', menuData);
      ...
      console.error('❌ Error preparing Domino\'s Pizza menu:', error);
  ...
  getMockMenu() {
    return {
      ...
      rewards: { program: 'Domino\'s Rewards', available: true, benefits: ['Earn points on every purchase'] },
...
const dominosAPI = new DominosAPI();
