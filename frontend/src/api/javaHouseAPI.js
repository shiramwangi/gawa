...
class JavaHouseAPI {
  ...
  async testAPIEndpoints() {
    console.log('🧪 Testing Java House API endpoints...');
  ...
  async getFullMenu() {
    try {
      console.log('🏪 Fetching Java House full menu...');
      ...
      console.log('✅ Java House menu data prepared:', menuData);
      ...
      console.error('❌ Error preparing Java House menu:', error);
